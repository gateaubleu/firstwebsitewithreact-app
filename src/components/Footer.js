...
import {APP_ROUTES, DISCORD_LINK} from '../config/Config';
           ...
           <div id="footer-content" className="container">
               <div className="row justify-content-around">
                   <div className="col-md-3 col-sm-3 col-3">
                       ...
                       <a target="_blank" rel="noopener noreferrer" className="icon" href={DISCORD_LINK}><img src={steamIcon} alt="Steam profile contact for support"/></a>
                   </div>
